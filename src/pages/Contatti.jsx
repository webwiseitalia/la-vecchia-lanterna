      ...
      <section className="section-spacing px-6 md:px-12">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-12">
          ...
          <div className="lg:col-span-5 space-y-6">
            ...
            <div className="contact-card bg-[#25D366] p-6 md:p-8 text-white" style={{ marginLeft: '20px' }}>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            ...
            <div>
              ...
              <h2 className="text-title text-[var(--color-wood-dark)] mb-6">
                Nel cuore<br />
                <span className="ml-8">delle Alpi</span>
              </h2>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-center">
            <div className="lg:col-span-6">
              ...
              <h2 className="text-display text-[var(--color-cream)] mb-6">
                Prenota il tuo<br />
                <span className="ml-12 text-[var(--color-gold)]">tavolo</span>
              </h2>
